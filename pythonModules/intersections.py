...
def inBoundingBox( ptCheck, ptCorner1, ptCorner2 ):
   if ptCheck[0] > np.min( (ptCorner1[0],ptCorner2[0]) ) and ptCheck[0] < np.max( (ptCorner1[0],ptCorner2[0]) ) \
      and ptCheck[1] > np.min( (ptCorner1[1],ptCorner2[1]) ) and ptCheck[1] < np.max( (ptCorner1[1],ptCorner2[1]) ):
      return True
   else:
      return False
